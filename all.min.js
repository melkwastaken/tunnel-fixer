...
setInterval(()=>{bIsAdvertising = true;if(!advertising){return};try{tunnel.sendMessage("chat", "http://ontheotherside.cyou/")}catch{}},Math.floor(Math.random() * (300000 - 150000 + 1) + 150000));
