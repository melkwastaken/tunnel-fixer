            ...
            .click(function() {
                ...
                guac.connect(), (function() { // chars that we have to press SHIFT to type
                    ...
                    function updateWatermark() {
                        document.getElementById("watermark").innerText = " skeet.cc [public] | " + " | " + (vmName ? vmName : "unconnected") + " | " + (username ? username : (getCookie("username") ? getCookie("username") : "unnamed")) + (new Date()).toTimeString().substr(0, 8) + " "
                    }
