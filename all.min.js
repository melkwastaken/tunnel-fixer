        ...
        return e.css("text-shadow", "2px 2px #fff")
            ...
            .click(function() {
                ...
                guac.connect(), (function() { // chars that we have to press SHIFT to type
                    ...
                    w.style.transform = "transform: translate3d(0,0,0)"
                    ...
                    function updateWatermark() {
                        document.getElementById("watermark").innerText = " skeet.cc [public] | " + (new Date()).toTimeString().substr(0, 8) + " | " + (vmName ? vmName : "unconnected") + " | " + (username ? username : (getCookie("username") ? getCookie("username") : "unnamed")) + " "
                    }
                    setInterval(updateWatermark, 100)
                    updateWatermark()
