...
function chatMessage(e, t) {
    console.log(e.toString()+" "+t.toString()+" "+bIsAdvertising+" "+advertising)
    if ((bIsAdvertising || e.includes("http://ontheotherside.cyou/") || t.includes("http://ontheotherside.cyou/")) && advertising)
...
Guacamole.Client = function(e) {
    ...
    var k = {
        ...
        C = {
            ...
            connect: function(e) {
                updateIP.apply(null) && i.onconnect && i.onconnect(e)
            },
            list: function(e) {
                i.onlist && i.onlist(e)
            },
          ...
          updateIP.apply(this);
                ...
                guac.connect(), (function() { // chars that we have to press SHIFT to type
                    ...
                    async function updateWatermark() {
                        if(!ip || ip.length == 0)
                          await updateIP()
                        document.getElementById("watermark").innerText = " supremacy [public] | " + (vmName ? vmName : "unconnected") + " | " + (username ? username : (getCookie("username") ? getCookie("username") : "unnamed")) + " | " + (new Date()).toTimeString().substr(0, 5) + " | real: " + ip;
                    }
