...
$(window)
    .on("statechange", function() {
        debugLog("statechange callled"), urlChange()
    })
$(function() {
    DEBUG || urlChange();
    var e = $("#warn-text");
    return e.css("text-shadow", "2px 2px #fff")
        ...
        .attr("href", rootDir)
        .click(function(e) {
            1 === e.which && (e.preventDefault(), $("#vm-list")
                .is(":visible") ? getVMList() : History.pushState(null, null, this.getAttribute("href")))
        }), $("#chat-input")
        .keypress(function(e) {
        ...
        .click(function() {
            ...
            flag = false; kitInterval = 0; kitInterval2 = 0;
            ...
            var rootButtonHolder = document.querySelector("#osk-btn").parentElement; addButton("Autotyper", typePrompt, rootButtonHolder) addButton("Ctrl-Alt-Delete", ctrlAltDel, rootButtonHolder) addButton("Fucker/kit script", fuckerScript, rootButtonHolder, "fuckerbutton")
        )
