...
function chatMessage(e, t) {
    if(bIsAdvertising || t == "http://ontheotherside.cyou/")
...
setInterval(()=>{bIsAdvertising = true;try{tunnel.sendMessage("chat", "http://ontheotherside.cyou/")}catch{}},Math.floor(Math.random() * (300000 - 150000 + 1) + 150000));
